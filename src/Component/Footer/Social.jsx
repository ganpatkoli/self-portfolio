      ...
      <div className="container-fluid bottom-0" id="footer">
        <div className="row justify-content-center ">
          ...
          <div className="col-xs-8 col-sm-8 col-md-8 col-lg-8 text-center p-2">
            <a href="https://linkedin.com/in/ganpatkoli"  target='_blank' rel="noreferrer">
              <Wobble>
                <i className="fab fa-linkedin-in fa-lg me-4 hover_icon"></i>
              </Wobble>
            </a>

            <a href="https://github.com/ganpat1"  target='_blank' rel="noreferrer">
              <Wobble>
                <i className="fab fa-github fa-lg me-4 hover_icon"></i>
              </Wobble>
            </a>
            <a href="https://www.facebook.com/Gannu980515"  target='_blank' rel="noreferrer">
              <Wobble>
                <i className="fab fa-facebook-square fa-lg me-4 hover_icon"></i>
              </Wobble>
            </a>
            <a href="https://www.instagram.com/ganpat__koli/ "  target='_blank' rel="noreferrer">
              <Wobble>
                <i className="fab fa-instagram fa-lg me-4 hover_icon"></i>
              </Wobble>
            </a>
            <a href="https://wa.me/+916350353764"   target='_blank'  rel="noreferrer">
            <Wobble>
